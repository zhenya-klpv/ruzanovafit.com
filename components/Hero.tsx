...
export function Hero() {
  ...
  return (
    <header className="relative min-h-[92vh] flex flex-col justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center">
        <BoundedShape variant="hero" className="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      </div>

      <div className="relative z-10 max-w-6xl mx-auto grid gap-10 lg:grid-cols-12 lg:items-center">
        <div
          className="text-center lg:text-left lg:col-span-7"
          style={{ transform: `translateY(${headlineShift * -1}px)` }}
        >
          <p className="text-label uppercase tracking-[0.24em] text-ink-subtle mb-6 animate-fade-in">
            Ruzanova Fitness
          </p>
          ...
          <p className="mt-8 text-body text-ink-muted max-w-prose mx-auto lg:mx-0 animate-slide-up [animation-delay:0.25s] opacity-0 [animation-fill-mode:forwards]">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-4 animate-slide-up [animation-delay:0.4s] opacity-0 [animation-fill-mode:forwards]">
            <a
              href="#contact"
        ...
        <div
          className="animate-slide-up [animation-delay:0.3s] opacity-0 [animation-fill-mode:forwards] lg:col-span-5"
          style={{ transform: `translateY(${noteShift * -1}px)` }}
        >
          <article className="w-full max-w-md ml-auto ds-card-elevated p-6 editorial-note-animate">
          ...
          <p className="mt-2 text-[10px] text-ink-subtle/80 max-w-md ml-auto text-right tracking-wide">
